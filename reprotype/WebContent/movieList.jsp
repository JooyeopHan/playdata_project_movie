...
.subtitle {
	    ...
	    margin: 0 0 0 14vw;
     	...
     	font-weight : bold;
		background: linear-gradient(#D91883 0%, white 100%);
...
.subtitleyellow {
	    ...
	    margin: 0 0 0 14vw;
     	...
     	font-weight : bold;
		background: linear-gradient(#FAC919, white 100%);
		background-clip: text;
		-webkit-background-clip: text;
		color: transparent;
		filter: drop-shadow(2px 2px black);  
...
%>		
	...
	<div class="container mx-3 mt-3 row" style="max-width:100vw; height:5vh;">
		<h1 class = "subtitle"> 일일 박스 오피스 랭킹</h1>
	</div>
	<div class ="container grad" style = "background-color:#265ff0;   border-radius:30px; box-shadow : 1px 3px 10px 0px #D91883">
...
<div class="p-2" >
	...
	<div class ="container gradyellow" style = "background-color:#265ff0;   border-radius:30px; box-shadow : 1px 3px 10px 0px #FAC919"">
		<div class="container-fluid d-flex flex-row"  id="scroll" style="color:#265ff0; overflow:scroll; max-width:100vw; height:80vh;">
